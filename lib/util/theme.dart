...
class MaterialTheme {
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      onTertiaryFixedVariant: Color(0xff563a70),
  ...
  static ThemeData light() {
    return theme(lightScheme().toColorScheme(), true);
  }
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(0xff52366c),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff8668a2),
      ...
      tertiaryFixed: Color(0xff8668a2),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff6c5087),
  ...
  static ThemeData lightMediumContrast() {
    return theme(lightMediumContrastScheme().toColorScheme(), true);
  }
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff301449),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff52366c),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff52366c),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff3b2054),
      onTertiaryFixedVariant: Color(0xffffffff),
      surfaceDim: Color(0xffded8e0),
      surfaceBright: Color(0xfffdf7ff),
      surfaceContainerLowest: Color(0xffffffff),
  ...
  static ThemeData lightHighContrast() {
    return theme(lightHighContrastScheme().toColorScheme(), true);
  }
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      onTertiary: Color(0xff3f2458),
      tertiaryContainer: Color(0xff563a70),
  ...
  static ThemeData dark() {
    return theme(darkScheme().toColorScheme(), false);
  }
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      tertiary: Color(0xffe0bdfd),
      onTertiary: Color(0xff23063c),
      tertiaryContainer: Color(0xffa484c0),
      ...
      tertiaryFixedDim: Color(0xffdbb9f9),
      onTertiaryFixedVariant: Color(0xff452a5e),
      surfaceDim: Color(0xff141218),
      surfaceBright: Color(0xff3b383e),
      surfaceContainerLowest: Color(0xff0f0d13),
      surfaceContainerLow: Color(0xff1d1b20),
  ...
  static ThemeData darkMediumContrast() {
    return theme(darkMediumContrastScheme().toColorScheme(), false);
  }
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffe0bdfd),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixedDim: Color(0xffe0bdfd),
      onTertiaryFixedVariant: Color(0xff23063c),
      surfaceDim: Color(0xff141218),
      surfaceBright: Color(0xff3b383e),
      surfaceContainerLowest: Color(0xff0f0d13),
      surfaceContainerLow: Color(0xff1d1b20),
  ...
  static ThemeData darkHighContrast() {
    return theme(darkHighContrastScheme().toColorScheme(), false);
  }
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xff9d21ff),
    value: Color(0xff9d21ff),
    light: ColorFamily(
      color: Color(0xff6f528a),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xfff0dbff),
      onColorContainer: Color(0xff290c42),
    ),
    ...
    dark: ColorFamily(
      ...
      onColor: Color(0xff3f2458),
      colorContainer: Color(0xff563a70),
      onColorContainer: Color(0xfff0dbff),
    ),
