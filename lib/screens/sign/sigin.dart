...
class _CandidateSiginState extends State<CandidateSigin>
                  ...
                  children: [
                    Padding(
                      padding: EdgeInsets.only(
                          top: 10, right: 12, bottom: size.height * 0.07),
                      child: const Row(
                    ...
                    const Text(
                      "  Candidate \n  Sign-in/Signup",
                      style: TextStyle(
                          fontSize: 28.5, fontWeight: FontWeight.bold),
                    ),
                    const Padding(
                    ...
                    InternationalPhoneNumberInput(
                      ...
                      onFieldSubmitted: (value) =>
                          userProvider.signIn(value).then(
                        (response) {
